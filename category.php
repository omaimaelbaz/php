...
<!--  modal ajouter  -->
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div data-toggle="modal" data-target="#update<?php echo $row["CategoryID"] ?>" class="fa-hover col-lg-3 col-md-6">
    ...
    ?>
    <!-- modal upadate -->
    <div class="modal fade" id="update<?php echo $row["CategoryID"] ?>" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" class="form-horizontal">
                        <div class="row form-group">
                            <div class="col col-md-3"><label for="hf-email" class=" form-control-label">category  name</label></div>
                            <div class="col-12 col-md-9"><input value='<?php echo $row["CategoryName"] ?>' type="text" id="hf-email" name="CategoryName"  placeholder=" Category Name updated ..."  class="form-control"></div>
                        </div>
                   
                        <input type="hidden" name="id_category" value='<?php echo $row["CategoryID"] ?>' id="">
                        <button type="submit" name='updatcategory' class="btn btn-primary btn-sm">
