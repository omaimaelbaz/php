...
if(isset($_POST["addUser"])){
    $username = $_POST["usernaeme"];
    $role = $_POST["role"];
    $email = $_POST["email"];
    $sql = "INSERT INTO utilisateur (nom_utilisateur, email, role)  VALUES ('$username', '$email', '$role')";
    $conn->query($sql);
}
// upadate 
if(isset($_POST["updatuser"])){
    ...
    $role = $_POST["role"];
    $email = $_POST["email"];
    $sql = "UPDATE utilisateur SET nom_utilisateur='$username', email='$email',role='$role' WHERE user_id =$id_user";
    $conn->query($sql);
}
//suprimer
...
<body>
                                ...
                                <div class="card-body card-block">
                                    <form method="post" class="form-horizontal">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9"><input type="text" id="hf-email" name="usernaeme"  placeholder="Entrer user name ..."  class="form-control"></div>
                                        </div>
                                        <div class="row form-group">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div data-toggle="modal" data-target="#update<?php echo $row["user_id"] ?>" class="fa-hover col-lg-3 col-md-6">
                                                    <a href="#"><i class="fa fa-glass"></i></a>
                                                </div>
                                                <div class="fa-hover col-lg-3 col-md-6">
                                                    <a href="users.php?id_user=<?php echo $row["user_id"]?>">S</a>
                                                </div>
                                            </td>
    ...
    while($row = $result->fetch_assoc()){
    ?>
    <div class="modal fade" id="update<?php echo $row["user_id"] ?>" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" class="form-horizontal">
                        <div class="row form-group">
                            <div class="col col-md-3"><label for="hf-email" class=" form-control-label">User name</label></div>
                            <div class="col-12 col-md-9"><input value='<?php echo $row["nom_utilisateur"] ?>' type="text" id="hf-email" name="usernaeme"  placeholder="Entrer user name ..."  class="form-control"></div>
                        </div>
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <select name="role" id=""  class="form-control">
                                    ...
                                    <option value="mombre" <?php if($row["role"]=="mombre") echo "selected"  ?>>mombre</option>
                                </select>
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-3"><label for="hf-email" class=" form-control-label">Email</label></div>
                            <div class="col-12 col-md-9"><input type="email" value='<?php echo $row["email"] ?>' id="hf-email" name="email" placeholder="Enter Email..." class="form-control"></div>
                        </div>
                        <input type="hidden" name="id_user" value='<?php echo $row["user_id"] ?>' id="">
                        <button type="submit" name='updatuser' class="btn btn-primary btn-sm">
